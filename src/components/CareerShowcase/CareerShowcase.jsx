    ...
    <>
      ...
      <div className="d-flex flex-align-center cs-main">
        ...
        <div className="d-flex cs-main__container">
          <div className="cs-main__left">
            <div className="cs-main__img-container">
              <img
                className="cs-main__img"
                src="https://www.strassacker.com/img/containers/assets/karriere/k-0.jpg/c7f967139f5e47dd731796f1b54809d6.webp"
              ></img>
            </div>
          </div>
          <div className="pos-relative cs-main__middle">
            <div className="pos-absolute cs-main__middleline"></div>
            <div className="pos-absolute d-flex  cs-main__title">
              <div className="d-flex flex-align-center cs-main__item">
                ...
                <div className=" d-flex flex-align-center cs-main__title-text">
                  <div className="text-uppercase cs-main__title-txt">mehr</div>
                  <div className="cs-main__title-sideline">
                    <div></div>
                  </div>
                </div>
              </div>
          ...
          <div className="cs-main__right">
            <div className="cs-main__img-container">
              <img
                className="cs-main__img"
                src="https://www.strassacker.com/img/containers/assets/karriere/88.jpg/3a18e3676d34a5f8283dca388e8ae006.webp"
              ></img>
            </div>
          </div>
        </div>
